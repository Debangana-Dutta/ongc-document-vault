...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid px-4">
        ...
        <!-- Extended User Management Summary -->
        <div class="row g-4 mb-5">
            <div class="col-12">
                <div class="card p-4 border-0 shadow-sm" style="border-radius: 14px;">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="stat-card" style="border-top-color:#10b981;">
                                <div class="text-success small fw-bold text-uppercase">Approved Users</div>
                                <div class="stat-value text-success"><asp:Label ID="lblApprovedUsers" runat="server" Text="0" /></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card" style="border-top-color:#f59e0b;">
                                <div class="text-warning small fw-bold text-uppercase">Pending Users</div>
                                <div class="stat-value text-warning"><asp:Label ID="lblPendingUsers" runat="server" Text="0" /></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card" style="border-top-color:#ef4444;">
                                <div class="text-danger small fw-bold text-uppercase">Rejected Users</div>
                                <div class="stat-value text-danger"><asp:Label ID="lblRejectedUsers" runat="server" Text="0" /></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>const text = "ONGC Document Indexing & Enterprise Retrieval System"; let i = 0; function typeWriter() {
...
} window.onload = typeWriter;</script>
</asp:Content>